...
class RecentDownloadAdapter(var recentDownloadList : List<MediaEntity>,private val context: Context)
    : RecyclerView.Adapter<RecentDownloadAdapter.RecentDownloadAdapterHolder>()
{
...
//                        playIcon.visibility = View.INVISIBLE
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecentDownloadAdapterHolder {
        return RecentDownloadAdapterHolder(LayoutInflater.from(parent.context).inflate(
            R.layout.recent_item_layout,parent,false
        ))
    }
